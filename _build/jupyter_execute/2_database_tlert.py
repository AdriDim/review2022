...
import pandas as pd
url='https://raw.githubusercontent.com/AdriDim/review2022/main/database_tlert_studies.csv'
...
data_table = DataTable(columns=Columns, source=ColumnDataSource(df), height = 500, width = 5000) # bokeh table
